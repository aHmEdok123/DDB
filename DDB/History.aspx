<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPageClient.Master" CodeBehind="History.aspx.vb" Inherits="DDB.History" %>
    ...
    <div class="col-md-12">
        <div class="full">
            <div class="main_heading text_align_center" style="margin-bottom: 40px">
                <h2>Quizzes Categories: History</h2>
                <p class="large">Feel free to browse all the different History Quizzes.</p>
            </div>
        </div>
    </div>
    ...
    <div style="width: 80%; margin: 0 auto;">
        <asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="0">
            <asp:View ID="vProducts" runat="server">
                ...
                <div class="Center">
                    <asp:DataList ID="dlProducts" runat="server" DataKeyField="ProductID" DataSourceID="dsHistory" ForeColor="Black" RepeatDirection="Horizontal" RepeatColumns="3" CellSpacing="25" CellPadding="10" Width="100%" class="text-center">
                        <ItemTemplate>
                ...
                <asp:SqlDataSource ID="dsHistory" runat="server" ConnectionString="<%$ ConnectionStrings:QuizzarooDBConnectionString %>" SelectCommand="SELECT * FROM [Products] WHERE ([ProductCategory] = @ProductCategory) ORDER BY ProductName">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="History" Name="ProductCategory" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </asp:View>
        ...
        <div class="modal-content1 animate">
            ...
            <asp:PlaceHolder ID="phLogin" Visible="False" runat="server">
                <div class="container1">
                    ...
                    <br>
                    <asp:ValidationSummary ID="ValidationSummaryLogin" runat="server" HeaderText="This is the list of errors: " ForeColor="Red" Font-Size="Large" DisplayMode="List" />
                    <br>
