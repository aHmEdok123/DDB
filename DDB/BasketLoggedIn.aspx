<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPageClientLoggedIn.Master" CodeBehind="BasketLoggedIn.aspx.vb" Inherits="DDB.BasketLoggedIn" %>
            ...
            <div style="margin-left: auto; margin-right: auto; width: 950px;">
                <div class="payment-form">
                    <table style="width: 100%;">
                        <tr>
                            <td style="border-bottom: 1px solid #ccc; height: 29px; width: 367px;"></td>
                            ...
                            <td style="border-bottom: 1px solid #ccc; height: 29px;"></td>
                        </tr>
                        <tr>
        ...
        <asp:View ID="vConfirmation" runat="server">
            <div style="margin-left: auto; margin-right: auto; width: 950px;">
                <div class="payment-form">
                    <table style="width: 100%;">
                        <tr>
                            <td style="border-bottom: 1px solid #ccc; height: 29px;" colspan="2"></td>
                            <td style="border-bottom: 1px solid #ccc; width: 351px; height: 29px;">
                                <asp:Label ID="lblMessage" runat="server" Font-Size="Large"></asp:Label>
                            </td>
                            <td style="border-bottom: 1px solid #ccc; height: 29px;">
                                <asp:Button ID="btnEmailConfirmation" runat="server" CssClass="btn sqaure_bt" Font-Size="Small" ForeColor="White" Text="Email Confirmation" />
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 19px; width: 126px;">
                            ...
                            <td style="height: 19px; width: 129px;"></td>
                            <td style="width: 351px; height: 19px;"></td>
                            <td style="height: 19px"></td>
                        </tr>
                    </table>
                </div>
